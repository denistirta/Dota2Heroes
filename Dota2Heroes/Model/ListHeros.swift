...
struct ListHeros: Codable {
    ...
    let attackRate, turnRate, baseManaRegen, baseArmor: Double?
    let moveSpeed: Int?
    let cmEnabled: Bool?
    ...
    func getBackgraundHero() -> String{
        let str = img ?? ""
        let strStart1 = ""
//            BaseURL.count
        let strStart2 = "/apps/dota2/images/heroes/".count
//        let strStart = strStart1 + strStart2
        
        let strEnd = "_full.png?".count
        
        let start = str.index(str.startIndex, offsetBy: strStart2)
        let end = str.index(str.endIndex, offsetBy: -strEnd)
